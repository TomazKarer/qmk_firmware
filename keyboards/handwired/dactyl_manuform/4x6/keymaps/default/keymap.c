    ...
    [_BASE] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,               KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_BSLS,
                          KC_LBRC, KC_RBRC,                                                KC_MINS, KC_EQL,
                                            ...
                                            KC_PGUP,  KC_DELETE,           KC_RALT,  KC_HOME,
...
//    ),
     ...
     */
    [_LOWER] = LAYOUT(
        KC_GRAVE,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,             KC_6,    KC_7,   KC_8,   KC_9,   KC_0,   KC_3,
     ...
     */
    [_RAISE] = LAYOUT(
        KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,             KC_CIRC, KC_AMPR, KC_ASTR, KC_LEFT_PAREN, KC_RIGHT_PAREN, ____,  
